...
import VideoButton from './videoButton/videoButtonComponent';
import AudioButton from './audioButton/audioButtonComponent';
    ...
    return(
        <div id="menu-buttons" ref={menuButtons} className="row">
            ...
            <div className="center justify-center text-end col-2">
                <HangupButton largeFeedEl={largeFeedEl} smallFeedEl={smallFeedEl} />
            </div>
        </div> 
    )
}
